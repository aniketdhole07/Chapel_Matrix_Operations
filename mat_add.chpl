...
proc sum_without_library(mat1: [1..n][1..n] int,mat2: [1..n][1..n] int) 
{
  var ans:[1..n][1..n] int;
  for i in 1..n do{
      for j in 1..n do{
...
proc sum_with_library(matrix1: [1..n, 1..n] int,matrix2: [1..n, 1..n] int) 
{
    var ans= matrix1+matrix2;
}
...
var watch1:Timer;
watch1.start();
sum_with_library(matrix1,matrix2);
watch1.stop();
